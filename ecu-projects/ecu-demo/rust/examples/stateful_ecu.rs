...
fn main() {
    ...
    let requests: &[&[u8]] = &[
        &[0x22, 0xF1, 0x90], // Default에서 RDBI → 7F 22 7F
        &[0x10, 0x03],       // Extended로 변경
        &[0x22, 0xF1, 0x90], // 정상 DID → 62 ...
        &[0x22, 0x12, 0x34], // 잘못된 DID → 7F 22 31
        &[0x22, 0xF1],       // 잘못된 길이 → 7F 22 13
        &[0x10, 0x05],       // 지원하지 않는 세션 → 7F 10 12
        &[0x10],             // 잘못된 길이 → 7F 10 13
        &[0x10, 0x01],       // Default로 복귀
        &[0x22, 0xF1, 0x90], // 다시 7F 22 7F
        &[0x99],             // 지원하지 않는 SID
        &[],
    ];
